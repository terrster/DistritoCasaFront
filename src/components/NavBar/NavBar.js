...
import logo  from '../../assets/logos_casa_color.png'
    ...
    <React.Fragment>
      ...
      <div id="navbar-dp" className="pos-f-t">
		 <Navbar collapseOnSelect className="nav-bar" expand="lg" bg="light" expanded={isOpen}>
		 	<Navbar.Brand href = {partners.includes(location.pathname.toLowerCase().split("/")[2]) || location.pathname.split("/").length > 3 || location.pathname === '/brokersCP' ?   "#" : "/"}><img src={logo} alt="Distrito Pyme Logo" width="300" height="300" className="nav-logo"/></Navbar.Brand>
